...
func GetAll%[3]s(c *gin.Context) {
	repositories.GetAll%[3]s(c)
}

func Get%[3]s(c *gin.Context) {
	repositories.Get%[3]s(c)
}

func Create%[3]s(c *gin.Context) {
	repositories.Create%[3]s(c)
}

func Update%[3]s(c *gin.Context) {
	repositories.Update%[3]s(c)
}

func Delete%[3]s(c *gin.Context) {
	repositories.Delete%[3]s(c)
}
`
